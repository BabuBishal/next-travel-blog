...
const page = () => {
  return (
    <div className="w-full mx-5 my-5 lg:w-[60%] lg:mx-auto">
      ...
      <div className="leading-8 text-lg bg-white relative mt-[-20px] rounded-lg p-5 shadow-xl max-md:mt-0 max-md:w-full max-md:bg-transparent max-md:shadow-none text-center ">
